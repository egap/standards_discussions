...
output:
  html_document:
    ...
    toc: true
    theme: journal
abstract: "This document is written as a helper for practitioners and others reading analyses of RCTs. It's informal and skips over some nuance, but links to pointers to more technical treatments. This is a living document and will be updated as more questions (or answers) come.<br><br>"
---
...
Also, the $p$-values for values near the edges of the 95% CI will be near .05
and near the center of that interval the (two-sided) $p$-values will be higher
than .05.
